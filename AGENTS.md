...
### Ansible
- **Ansible Lint**: `cd ansible && ansible-lint`
- **Syntax Check**: `cd ansible && ansible-playbook --syntax-check playbooks/<playbook>.yml`
- **Run Playbook**: `cd ansible && ansible-playbook -i inventory.ini playbooks/<playbook>.yml`
- **Test Role**: `cd ansible && ansible-playbook -i inventory.ini playbooks/test.yml --tags <role_name>`
