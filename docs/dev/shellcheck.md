...
ShellCheck is a static analysis tool for shell scripts. It finds bugs in your shell scripts and suggests improvements,
helping you write more robust and portable scripts.
